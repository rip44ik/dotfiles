...
return {
    {
        ...
        opts = {
            ...
            default_component_configs = {
                ...
                git_status = {
                    symbols = {
                        added     = "✚", -- Файл добавлен в индекс
                        modified  = "", -- Файл изменён, но не добавлен в индекс
                        deleted   = "✖", -- Файл удалён
                        renamed   = "➜", -- Файл переименован
                        untracked = "★", -- Новый файл, не отслеживаемый Git
                        ignored   = "◌", -- Проигнорированный файл
                        unstaged  = "✗", -- Изменённый файл, не добавлен в индекс
                        staged    = "+", -- Файл добавлен в индекс
                        conflict  = "═", -- Конфликт в слиянии
                    },
                    highlight = {
